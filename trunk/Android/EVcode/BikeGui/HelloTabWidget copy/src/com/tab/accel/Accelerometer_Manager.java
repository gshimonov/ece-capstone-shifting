 ...
 */
public class Accelerometer_Manager {
    ...
    private static Accelerometer_Listener listener;
    ...
    public static void configure(int threshold, int interval) {
        Accelerometer_Manager.threshold = threshold;
        Accelerometer_Manager.interval = interval;
    }
    ...
    public static void startListening(
            Accelerometer_Listener accelerometerListener) {
        sensorManager = (SensorManager) Accelerometer.getContext().
                getSystemService(Context.SENSOR_SERVICE);
        List<Sensor> sensors = sensorManager.getSensorList(
                Sensor.TYPE_ACCELEROMETER);
